...
namespace Elementor;
class glint_experince_dark_widget extends Widget_Base {
	...
	public function get_name() {
		return 'glint-experience-widget-dark';
	}
	...
	public function get_title() {
		return esc_html__( 'Dark Skill Box', 'glint-extra' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'settings_section',
			[
				'label' => esc_html__( 'Dark Skill Box', 'glint-extra' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
        ...
        $this->start_controls_section(
            ...
            [
                ...
                [
					...
					'default'   => '#ffffff',
                    'selectors' => [
                        '{{WRAPPER}} .skill-area .heading.white h2' => 'color: {{VALUE}}',
                    ]
                ]
            ); 
			...
			$this->add_control(
                ...
                [
					...
					'default'   => '#ffffff',
                    'selectors' => [
                        '{{WRAPPER}} .skill-area .info-content p' => 'color: {{VALUE}}',
                    ]
                ]
            );
            ...
            $this->add_group_control(
                ...
                [
                    'name'     => 'title_typography_news',
					'label'     => __( 'Title typography', 'growthcore' ),
                    'selector' => '{{WRAPPER}} .skill-area .heading.white h2',
                ]
            ); 
			...
			$this->add_group_control(
                Group_Control_Typography::get_type(),
                [
                    'name'     => 'sub_title_typography_da',
					'label'     => __( 'Sub Title typography', 'growthcore' ),
                    'selector' => '{{WRAPPER}} .skill-area .info-content p',
                ]
            );
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .skill-area .heading.white h2' => 'font-size: {{SIZE}}{{UNIT}};',
                    ],
                ]
            ); 
			...
			$this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .skill-area .info-content p' => 'font-size: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );		
        ...
        $this->start_controls_section(
			...
			$this->add_control(
                ...
                [
					...
					'default'   => '#08d665',
                    'selectors' => [
                        '{{WRAPPER}} .skill-box1 h5' => 'color: {{VALUE}}',
                    ]
                ]
            );
			...
			$this->add_control(
                ...
                [
					...
					'default'   => '#ffffff',
                    'selectors' => [
                        '{{WRAPPER}} .skill-box1 p' => 'color: {{VALUE}}',
                    ]
                ]
            );
			...
			$this->add_control(
                ...
                [
					...
					'default'   => '#ffffff',
                    'selectors' => [
                        '{{WRAPPER}} .skill-box1 small' => 'color: {{VALUE}}',
                    ]
                ]
            );
			...
			$this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .skill-box1 h5',
                ]
            );
			...
			$this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .skill-box1 small',
                ]
            );
			...
			$this->add_group_control(
                Group_Control_Typography::get_type(),
                [
                    'name'     => 'skill_innr_typography',
					'label'     => __( 'Skill Content Typography', 'growthcore' ),
                    'selector' => '{{WRAPPER}} .skill-box1 p',
                ]
            );
			...
			$this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .skill-box1 h5' => 'font-size: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
			...
			$this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .skill-box1 p' => 'font-size: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
			...
			$this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .skill-box1 small' => 'font-size: {{SIZE}}{{UNIT}};',
                    ],
                ]
            );
			...
			$this->add_responsive_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .skill-box1' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
					'separator' =>'before'
				]
			);
	...
	protected function render() {
		...
		<div class="area__bg"></div>
            <div class="container">
                ...
                <div class="row justify-content-center skill__wrap">
...
Plugin::instance()->widgets_manager->register( new glint_experince_dark_widget() );